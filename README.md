...
### Смена картинки (аватара) чата
1. Выберите нужный чат из списка
2. Нажмите на кнопуку настроек чата и выберете пунки "Изменить изображение чата"
3. В появившемся окне выберите файл изображения
4. Загрузка происходит автоматически
...
Минимальная версия Node.js: **24.13.1**
